...
col_names = ['city_fuel_economy',
			 ...
			 'model_570S',
			 'model_575M',
			 'model_599 GTB Fiorano',
			 'model_6 Series',
			 'model_6 Series Gran Turismo',
			 'model_600LT',
			 'model_612 Scaglietti',
			 'model_626',
			 'model_650S',
			 'model_675LT',
			 'model_7 Series',
			 ...
			 'model_Accord',
			 'model_Accord Coupe',
			 'model_Accord Crosstour',
			 'model_Accord Hybrid',
			 'model_Accord Hybrid Plug-In ',
			 'model_ActiveHybrid 3',
			 'model_ActiveHybrid 7',
			 'model_Alero',
			 'model_Allante',
			 'model_Allroad',
			 'model_Altima',
			 ...
			 'model_CT5',
			 'model_CT6',
			 'model_CT6 Hybrid Plug-In ',
			 'model_CTS',
			 'model_CTS Coupe',
			 'model_CTS Sport Wagon',
			 'model_CTS-V',
			 'model_CTS-V Coupe',
			 'model_CTS-V Wagon',
			 'model_CX-3',
			 ...
			 'model_Cavalier',
			 'model_Cayenne',
			 'model_Cayenne E-Hybrid',
			 'model_Cayenne Hybrid',
			 'model_Cayman',
			 'model_Celica',
			 'model_Century',
			 'model_Challenger',
			 ...
			 'model_Civic',
			 'model_Civic Coupe',
			 'model_Civic Hatchback',
			 'model_Civic Hybrid',
			 'model_Civic Type R',
			 'model_Civic del Sol',
			 'model_Clarity Hybrid Plug-In ',
			 'model_Classic',
			 'model_Cobalt',
			 'model_Colorado',
			 'model_Commander',
			 ...
			 'model_Concorde',
			 'model_Continental',
			 'model_Continental Flying Spur',
			 'model_Continental GT',
			 'model_Continental GTC',
			 'model_Continental Supersports',
			 'model_Contour',
			 'model_Cooper',
			 'model_Cooper Clubman',
			 'model_Cooper Coupe',
			 'model_Cooper Paceman',
			 'model_Corolla',
			 'model_Corolla Hatchback',
			 'model_Corolla Hybrid',
			 'model_Corolla iM',
			 'model_Corsair',
			 'model_Corvette',
			 'model_Cougar',
			 'model_Countryman',
			 'model_Countryman Hybrid Plug-in ',
			 'model_Crossfire',
			 'model_Crossfire SRT-6',
			 'model_Crosstour',
			 'model_Crosstrek',
			 'model_Crosstrek Hybrid',
			 'model_Crown Victoria',
			 'model_Cruze',
			 'model_Cruze Limited',
			 'model_Cube',
			 'model_Cullinan',
			 'model_Cutlass Supreme',
			 'model_DB11',
			 'model_DB9',
			 'model_DBS',
			 'model_DTS',
			 ...
			 'model_Diamante',
			 'model_Discovery',
			 'model_Discovery Sport',
			 'model_Durango',
			 'model_Durango Hybrid',
			 'model_E-Class',
			 'model_E-PACE',
			 'model_E-Series',
			 'model_ECHO',
			 ...
			 'model_Eclipse',
			 'model_Eclipse Cross',
			 'model_Eclipse Spyder',
			 'model_EcoSport',
			 'model_Edge',
			 'model_Eighty-Eight',
			 'model_Eighty-Eight Royale',
			 'model_Elantra',
			 'model_Elantra Coupe',
			 'model_Elantra GT',
			 'model_Elantra Touring',
			 'model_Eldorado',
			 'model_Electra',
			 'model_Element',
			 'model_Elise',
			 ...
			 'model_Escalade ESV',
			 'model_Escalade EXT',
			 'model_Escalade Hybrid',
			 'model_Escape',
			 'model_Escape Hybrid',
			 'model_Escape Hybrid Plug-in',
			 'model_Escort',
			 'model_EuroVan',
			 'model_Evora',
			 'model_Expedition',
			 'model_Explorer',
			 'model_Explorer Hybrid',
			 'model_Explorer Sport',
			 'model_Explorer Sport Trac',
			 'model_Express',
			 'model_Express Cargo',
			 'model_F-150',
			 'model_F-150 Heritage',
			 'model_F-150 SVT Lightning',
			 'model_F-PACE',
			 'model_F-TYPE',
			 'model_F12 Berlinetta',
			 'model_F430',
			 'model_F430 Spider',
			 'model_FF',
			 'model_FJ Cruiser',
			 ...
			 'model_IS 350',
			 'model_Impala',
			 'model_Impala Limited',
			 'model_Impreza',
			 'model_Impreza WRX',
			 'model_Impreza WRX STI',
			 'model_Insight',
			 'model_Integra',
			 'model_Intrepid',
			 'model_Intrigue',
			 'model_Ioniq Hybrid',
			 'model_Ioniq Hybrid Plug-In ',
			 'model_JX35',
			 'model_Jetta',
			 'model_Jetta GLI',
			 'model_Jetta Hybrid',
			 'model_Jetta SportWagen',
			 'model_Jimmy',
			 'model_Journey',
			 'model_Juke',
			 'model_K5',
			 ...
			 'model_LaCrosse',
			 'model_Lancer',
			 'model_Lancer Evolution',
			 'model_Lancer Sportback',
			 'model_Land Cruiser',
			 'model_LeSabre',
			 'model_Legacy',
			 'model_Levante',
			 ...
			 'model_Mulsanne',
			 'model_Murano',
			 'model_Murano CrossCabriolet',
			 'model_Murano Hybrid',
			 'model_Murcielago',
			 'model_Mustang',
			 'model_Mustang SVT Cobra',
			 'model_Mustang Shelby GT350',
			 'model_Mustang Shelby GT500',
			 'model_NSX',
			 'model_NV200',
			 'model_NX',
			 'model_NX 200t',
			 ...
			 'model_New Yorker',
			 'model_Niro',
			 'model_Niro Hybrid Plug-In',
			 'model_Nitro',
			 'model_Odyssey',
			 'model_Optima',
			 'model_Optima Hybrid',
			 'model_Optima Hybrid Plug-In ',
			 'model_Outback',
			 'model_Outlander',
			 'model_Outlander Hybrid Plug-in ',
			 'model_Outlander Sport',
			 'model_Outlook',
			 'model_PT Cruiser',
			 'model_Pacifica',
			 'model_Pacifica Hybrid',
			 'model_Palisade',
			 'model_Panamera',
			 'model_Panamera E-Hybrid',
			 'model_Panamera Hybrid',
			 'model_Park Avenue',
			 'model_Passat',
			 'model_Passport',
			 'model_Pathfinder',
			 'model_Pathfinder Hybrid',
			 'model_Patriot',
			 'model_Phantom',
			 'model_Phantom Drophead Coupe',
			 'model_Pickup',
			 'model_Pilot',
			 'model_Portofino',
			 'model_Prelude',
			 ...
			 'model_RL',
			 'model_RLX',
			 'model_RLX Hybrid Sport',
			 'model_RS 3',
			 'model_RS 5',
			 'model_RS 5 Sportback',
			 'model_RS 7',
			 'model_RS Q8',
			 'model_RSX',
			 'model_RX',
			 ...
			 'model_Rainier',
			 'model_Range Rover',
			 'model_Range Rover Evoque',
			 'model_Range Rover Hybrid',
			 'model_Range Rover Hybrid Plug-in',
			 'model_Range Rover Sport',
			 'model_Range Rover Velar',
			 'model_Ranger',
			 'model_Ranger Chassis',
			 'model_Rapide',
			 'model_Regal',
			 'model_Regal Sportback',
			 'model_Regal TourX',
			 'model_Regency',
			 'model_Rendezvous',
			 'model_Renegade',
			 ...
			 'model_Sienna',
			 'model_Sierra 1500',
			 'model_Sierra 1500 Hybrid',
			 'model_Sierra 1500 Limited',
			 'model_Sierra 1500HD',
			 'model_Sierra 2500HD',
			 'model_Sierra Classic 1500',
			 'model_Silhouette',
			 'model_Silverado 1500',
			 'model_Silverado 1500HD',
			 'model_Silverado Classic 1500',
			 'model_Silverado Classic 1500HD',
			 'model_Silverado Hybrid',
			 'model_Silverado SS',
			 'model_Sky',
			 'model_Skylark',
			 'model_Solstice',
			 ...
			 'model_Tracker',
			 'model_Trailblazer',
			 'model_Trailblazer EXT',
			 'model_Transit Cargo',
			 'model_Transit Connect',
			 'model_Transit Crew',
			 'model_Transit Passenger',
			 'model_Traverse',
			 'model_Trax',
			 'model_Tribeca',
			 'model_Tribute',
			 'model_Tribute Hybrid',
			 'model_Trooper',
			 'model_Truck',
			 'model_Tucson',
			 'model_Tundra',
